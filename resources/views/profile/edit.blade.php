            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="farm_details">{{ __('Farm Details') }}</label>
                            <textarea id="farm_details" class="form-control @error('farm_details') is-invalid @enderror" name="farm_details">{{ old('farm_details', $user->farm_details) }}</textarea>
